...
paramBistatic.rngRes = 50;
paramBistatic.timeRes = 64*(1/paramBistatic.PRF);
paramBistatic.timeSpan = 7*64*(1/paramBistatic.PRF);
paramBistatic.dopOff = dop2speed(-3125/2,paramBistatic.pspeed/paramBistatic.Fc);
paramBistatic.dopRes = dop2speed(3125/256,paramBistatic.pspeed/paramBistatic.Fc);
