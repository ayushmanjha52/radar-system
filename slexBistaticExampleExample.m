...
% This example shows how to simulate a bistatic radar system with two
...
% range-time intensity plot and Doppler-time intensity plot.
...
% map shows these two values as the measured values.
%
...
% sum values.
%
% The Range-Time Intensity scope and Doppler-Time Intensity scope shows the
% scrolling range and Doppler response intensities over time which
% matches the measured values range and speed values.
%
% <<../Bistatic_RTI.gif>>
%
% <<../Bistatic_DTI.gif>>
